...
As of Bitweb Core v30.2, releases are signed by a number of public keys on the basis
of the [guix.sigs repository](https://github.com/Bitwebissss/guix.sigs/). When
...
builder-keys](https://github.com/Bitwebissss/guix.sigs/tree/main/builder-keys) and
...
signature file `SHA256SUMS.asc` from https://bitwebcore.net.
...
./contrib/verify-binaries/verify.py bin ~/Downloads/SHA256SUMS \
    ~/Downloads/bitweb-24.0.1-x86_64-linux-gnu.tar.gz \
    ~/Downloads/bitweb-24.0.1-arm-linux-gnueabihf.tar.gz
```
