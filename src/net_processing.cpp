...
static constexpr auto HEADERS_DOWNLOAD_TIMEOUT_BASE = 20min; /* Bitweb Params */
...
static constexpr auto CHAIN_SYNC_TIMEOUT{40min}; /* Bitweb Params */
...
static constexpr auto BLOCK_STALLING_TIMEOUT_DEFAULT{8s}; /* Bitweb Params */
/** Maximum timeout for stalling block download. */
static constexpr auto BLOCK_STALLING_TIMEOUT_MAX{128s}; /* Bitweb Params */
...
private:
    ...
    */
     ...
     * announcements for blocks interacting with the 5m (MAX_FUTURE_BLOCK_TIME) rule). */
