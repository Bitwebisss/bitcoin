...
```sh
cmake --build build --target bitwebd bitweb-cli
cmake --build build --target bitweb-qt
cmake --build build --target bench_bitweb
```
...
[remote "upstream-pull"]
        ...
        url = git@github.com:Bitwebissss/bitweb.git
```
...
> e.g. github.com/Bitwebissss/bitweb.git
